<template>
      ...
      <div class="card-toolbar">
        ...
        <div class="d-flex justify-content-end align-items-center">
          ...
          <button
            ...
            data-bs-target="#kt_modal_add_settings_type"
            @click="showAddSettingsTypeModal('Add', {})"
          >
      ...
      >
        ...
        <template v-slot:actions="{ row: data }">
          <button
            ...
            @click="showAddSettingsTypeModal('Edit', data)"
            data-bs-toggle="modal"
            id="edit-btn"
            data-bs-target="#kt_modal_add_settings_type"
          >
  ...
  <!--Add settingsType Modal-->
  <div
    class="modal fade"
    id="kt_modal_add_settings_type"
    ref="settingsTypeModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <el-form
          class="form"
          @submit.prevent="processSettingsTypeAction()"
          :model="settingsType"
          :rules="modalFormRules"
          ref="formSettingsTypeRef"
        >
          <!--begin::Modal header-->
          <div class="modal-header" id="kt_modal_new_settings_type_header">
            <!--begin::Modal title-->
            <h2>{{ settingsType.action }} Settings Type</h2>
            <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_new_settings_type_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_new_settings_type_header"
              data-kt-scroll-wrappers="#kt_modal_new_settings_type_scroll"
          ...
          <div class="modal-footer flex-center">
            ...
            <button
              type="reset"
              id="kt_modal_add_settings_type_cancel"
...
export default defineComponent({
  name: "admin-manage-general-settings-types",
  components: {
    KTDatatable,
    PermissionDenied,
    PageLoader,
  ...
  setup() {
    ...
    const formSettingsTypeRef = ref<null | HTMLFormElement>(null);
    const settingsTypeModalRef = ref<null | HTMLElement>(null);
    ...
    const processSettingsTypeAction = () => {
      if (!formSettingsTypeRef.value) {
        return;
      }

      formSettingsTypeRef.value.validate((valid) => {
        if (valid) {
          refData.value.loadingAction = true;

          switch (settingsType.value.action) {
            case "Add":
              settingStore
                .addSettingsType(settingsType.value)

                .then(() => {
                  getSettingsTypes(table_options.value);

                  hideModal(settingsTypeModalRef.value);
            ...
            case "Edit":
              settingStore
                .updateSettingsType(settingsType.value)
                .then(() => {
    ...
    //modals
    const showAddSettingsTypeModal = (action, data) => {
      if (action === "Add") {
        settingsType.value.name = "";
      } else {
        settingsType.value = data;
      }

      settingsType.value.action = action;
    };
    ...
    return {
      ...
      handlePerPageChange,
      sortingChanged,
      processSettingsTypeAction,
      searchRecords,

      //modals
      showAddSettingsTypeModal,
