  ...
  <div class="card">
      ...
      <div class="card-toolbar">
        ...
        <div class="d-flex justify-content-end align-items-center">
          ...
          <button
            ...
            @click="showAddLanguageModal('Add', {})"
          >
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:alias="{ row: data }">
          {{ data.alias }}
        </template>
        ...
        <template v-slot:actions="{ row: data }">
          <button
            ...
            @click="showAddLanguageModal('Edit', data)"
            data-bs-toggle="modal"
            id="edit-btn"
            data-bs-target="#kt_modal_add_language"
          >
  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <el-form
          class="form"
          @submit.prevent="processLanguageAction()"
          :model="language"
          :rules="modalFormRules"
          ref="formLanguageRef"
        >
          <!--begin::Modal header-->
          <div class="modal-header" id="kt_modal_new_language_header">
            <!--begin::Modal title-->
            <h2>{{ language.action }} Details</h2>
            <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_new_language_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_new_language_header"
              data-kt-scroll-wrappers="#kt_modal_new_language_scroll"
          ...
          <div class="modal-footer flex-center">
            ...
            <button
              type="reset"
              id="kt_modal_add_language_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const formLanguageRef = ref<null | HTMLFormElement>(null);
    const languageModalRef = ref<null | HTMLElement>(null);
    ...
    const processLanguageAction = () => {
      if (!formLanguageRef.value) {
        return;
      }

      formLanguageRef.value.validate((valid) => {
        if (valid) {
          refData.value.loadingAction = true;

          switch (language.value.action) {
            case "Add":
              languageStore
                .addLanguage(language.value)

                .then(() => {
                  getLanguages(table_options.value);

                  hideModal(languageModalRef.value);
    ...
    const showAddLanguageModal = (action, data) => {
      if (action === "Add") {
        language.value.name = "";
