<template>
    ...
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-toolbar">
        ...
        <div class="d-flex justify-content-end align-items-center">
          ...
          <!--            @click="showCustomerGroupModal('Add', {})"-->
          <!--          >-->
      ...
      >
        ...
        <template v-slot:actions="{ row: data }">
          <button
            ...
            @click="showCustomerGroupModal('Edit', data)"
            data-bs-toggle="modal"
            id="edit-btn"
            data-bs-target="#kt_modal_add_customer_group"
          >
  ...
  <!--Add customerGroup Modal-->
  <div
    class="modal fade"
    id="kt_modal_add_customer_group"
    ref="customerGroupModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <el-form
          class="form"
          @submit.prevent="processCustomerGroupAction()"
          :model="customerGroup"
          :rules="modalFormRules"
          ref="formCustomerGroupRef"
        >
          <!--begin::Modal header-->
          <div class="modal-header" id="kt_modal_new_customer_group_header">
            <!--begin::Modal title-->
            <h2>{{ customerGroup.action }} Customer Group</h2>
            <!--end::Modal title-->
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_customer_group_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_new_customer_group_header"
              data-kt-scroll-wrappers="#kt_modal_customer_group_scroll"
          ...
          <div class="modal-footer flex-center">
            ...
            <button
              type="reset"
              id="kt_modal_add_customer_group_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const { customerGroups, meta, loadingCustomerData, unauthorized } =
      storeToRefs(customerStore);
    const { getCustomerGroups } = useAdminCustomerStore();
    ...
    const formCustomerGroupRef = ref<null | HTMLFormElement>(null);
    const customerGroupModalRef = ref<null | HTMLElement>(null);
    ...
    const processCustomerGroupAction = () => {
      if (!formCustomerGroupRef.value) {
        return;
      }

      formCustomerGroupRef.value.validate((valid) => {
        if (valid) {
          refData.value.loadingAction = true;

          switch (customerGroup.value.action) {
            case "Add":
              break;
            case "Edit":
              customerStore
                .updateCustomerGroup(customerGroup.value)
                .then(() => {
                  refData.value.loadingAction = false;

                  getCustomerGroups(table_options.value);
    ...
    //modal
    const showCustomerGroupModal = (action, data) => {
      if (action === "Add") {
        customerGroup.value.name = "";
      } else {
        customerGroup.value.name = data.name;
        customerGroup.value.id = data.id;
      }

      customerGroup.value.action = action;
    };
    ...
    return {
      //variables
      refData,
      customerGroupModalRef,
      formCustomerGroupRef,
      modalFormRules,
      tableHeader,
