...
export default defineComponent({
  ...
  setup() {
    ...
    const { smsReports, meta, loadingData } = storeToRefs(smsStore);
    const { getSmsReports } = useCustomerSmsStore();
    ...
    //functions
    // const getReports = async (table_options): Promise<void> => {
    //   refData.value.loadingData = true;
    //
    //   await store
    //     .dispatch("sms/getSMSReports", table_options)
    //     .then((response) => {
